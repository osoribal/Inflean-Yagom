...
class AlbumCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        // 사진 라이브러리 변경을 감지할 수 있도록 옵저버 등록
        PHPhotoLibrary.shared().register(self)
    }
    
    deinit {
        // 사진 라이브러리 변경 감지 중단을 위해 옵저버 등록 해제
...
extension AlbumCollectionViewController: UICollectionViewDelegateFlowLayout {
    ...
    // Main.storyboard -> collection view -> estimate size = none
    func collectionView(_ collectionView: UICollectionView,
        ...
        //print("left : \(sectionInset.left), right : \(sectionInset.right)")
